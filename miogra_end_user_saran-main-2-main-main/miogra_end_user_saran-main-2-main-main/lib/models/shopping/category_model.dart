...
//
//     final categoryBasedShop = categoryBasedShopFromJson(jsonString);

import 'dart:convert';

List<CategoryBasedShop> categoryBasedShopFromJson(String str) => List<CategoryBasedShop>.from(json.decode(str).map((x) => CategoryBasedShop.fromJson(x)));

String categoryBasedShopToJson(List<CategoryBasedShop> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CategoryBasedShop {
    String? productId;
    String? shopId;
    String? status;
    String? category;
    ...
    factory CategoryBasedShop.fromJson(Map<String, dynamic> json) => CategoryBasedShop(
        productId: json["product_id"],
        shopId: json["shop_id"],
        status: json["status"],
        category: json["category"],
