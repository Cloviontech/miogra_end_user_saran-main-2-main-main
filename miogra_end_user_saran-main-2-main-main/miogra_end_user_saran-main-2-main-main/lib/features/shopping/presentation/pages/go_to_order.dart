...
//Address
  ...
  void initState() {
    ...
    fetchFoodDataFromListJson();

    // fetchFetchFreshCutDataFromListJson();
  }
  ...
  Future<dynamic> fetchDataFromListJson() async {
    String url =
        'https://${ApiServices.ipAddress}/get_single_shopproduct/${widget.shopId}/${widget.productId}';
        ...
        if (data is List) {
          ...
          try {
            setState(() {
              ...
              totalPrice = data[0]['product']['selling_price'];
  ...
  Future<dynamic> fetchFetchFreshCutDataFromListJson() async {
    String url =
        'https://${ApiServices.ipAddress}/single_freshproduct/${widget.shopId}/${widget.productId}';
        ...
        if (data is List) {
          ...
          try {
            setState(() {
              ...
              oldPrice = data[0]['product']['actual_price'].toString();
              dynamic sellingPrice = data[0]['product']['selling_price'];
  ...
  Future<dynamic> fetchFoodDataFromListJson() async {
    String url =
        'https://${ApiServices.ipAddress}/single_foodproduct/${widget.shopId}/${widget.productId}';
        ...
        if (data is List) {
          ...
          try {
            setState(() {
              ...
              productName = data[0]['product']['model_name'].toString();
              productId = data[0]['product_id'].toString();
              shopeId = data[0]['food_id'].toString();
              brandName = data[0]['product']['brand'].toString();
              // productPrice = data[0]['product']['selling_price'].toString();
              // description =
              //     data[0]['product']['product_description'].toString();
