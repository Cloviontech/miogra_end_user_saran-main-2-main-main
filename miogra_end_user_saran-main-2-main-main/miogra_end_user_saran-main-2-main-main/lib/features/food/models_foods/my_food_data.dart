...
//
//     final myFoodData = myFoodDataFromJson(jsonString);

import 'dart:convert';

MyFoodData myFoodDataFromJson(String str) => MyFoodData.fromJson(json.decode(str));

String myFoodDataToJson(MyFoodData data) => json.encode(data.toJson());
...
class MyFoodData {
    ...
    factory MyFoodData.fromJson(Map<String, dynamic> json) => MyFoodData(
