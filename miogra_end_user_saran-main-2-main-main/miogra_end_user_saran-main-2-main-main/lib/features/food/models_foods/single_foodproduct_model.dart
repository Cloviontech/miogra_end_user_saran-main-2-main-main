...
//
//     final singleFoodproduct = singleFoodproductFromJson(jsonString);

import 'dart:convert';

List<SingleFoodproduct> singleFoodproductFromJson(String str) => List<SingleFoodproduct>.from(json.decode(str).map((x) => SingleFoodproduct.fromJson(x)));

String singleFoodproductToJson(List<SingleFoodproduct> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SingleFoodproduct {
    String productId;
    String foodId;
    String status;
    String category;
    ...
    factory SingleFoodproduct.fromJson(Map<String, dynamic> json) => SingleFoodproduct(
