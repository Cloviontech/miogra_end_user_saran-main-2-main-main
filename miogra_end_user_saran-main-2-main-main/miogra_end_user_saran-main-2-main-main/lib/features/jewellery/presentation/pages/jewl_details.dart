...
import 'package:miogra/features/jewellery/presentation/pages/go_to_order_gold.dart';
import 'package:miogra/features/jewellery/presentation/pages/go_to_order_silver.dart';
...
class JewlProductsDetails extends StatefulWidget {
  const JewlProductsDetails({
    super.key,
  ...
  @override
  State<JewlProductsDetails> createState() => _JewlProductsDetailsState();
}

class _JewlProductsDetailsState extends State<JewlProductsDetails> {
  String image = '';
  String productName = '';
  ...
  Future<dynamic> getSingleJuelProduct() async {
    String url =
        'https://${ApiServices.ipAddress}/single_jewelproduct/${widget.shopeid}/${widget.productId}';
        ...
        if (data is List) {
          ...
          try {
            setState(() {
              ...
              shopeId = data[0]['jewel_id'].toString();
              ...
              rating = data[0]['rating'] ?? 0.0.toString();
