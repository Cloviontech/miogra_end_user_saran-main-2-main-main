...
class GoToOrderJuelGold extends StatefulWidget {
  ...
  @override
  State<GoToOrderJuelGold> createState() => _GoToOrderJuelGoldState();
}

class _GoToOrderJuelGoldState extends State<GoToOrderJuelGold> {
  String userId = '';
  String image = '';
  String productName = '';
  String productId = '';
...
//Address
  ...
  Future<dynamic> fetchDataFromListJson() async {
    String url =
        'https://${ApiServices.ipAddress}/single_jewelproduct/${widget.shopId}/${widget.productId}';
