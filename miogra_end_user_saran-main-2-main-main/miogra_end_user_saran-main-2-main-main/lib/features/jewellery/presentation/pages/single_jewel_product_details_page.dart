...
class JewelProductDetailsPage extends StatefulWidget {
  ...
  const JewelProductDetailsPage(
      {super.key, this.productId, this.shopId, this.link, this.subCategory});

  @override
  State<JewelProductDetailsPage> createState() =>
      _JewelProductDetailsPageState();
}
...
class _JewelProductDetailsPageState extends State<JewelProductDetailsPage> {
  ...
  Future<List<AllJewelproducts>> fetchSingleJewelProduct(
    ...
    if (response.statusCode == 200) {
      ...
      return jsonResponse
          .map((json) => AllJewelproducts.fromJson(json))
          .toList();
    } else {
...
// futurefetchSingleJewelproduct =  fetchSingleJewelproduct(widget.shopId.toString(), widget.productId.toString())  ;
    futurefetchSingleJewelproduct = fetchSingleJewelProduct(
