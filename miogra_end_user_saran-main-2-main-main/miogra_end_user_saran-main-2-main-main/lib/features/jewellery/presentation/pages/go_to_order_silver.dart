...
class GoToOrderJuelSilver extends StatefulWidget {
  ...
  @override
  State<GoToOrderJuelSilver> createState() => _GoToOrderJuelSilverState();
}

class _GoToOrderJuelSilverState extends State<GoToOrderJuelSilver> {
  String userId = '';
  String image = '';
  String productName = '';
  String productId = '';
