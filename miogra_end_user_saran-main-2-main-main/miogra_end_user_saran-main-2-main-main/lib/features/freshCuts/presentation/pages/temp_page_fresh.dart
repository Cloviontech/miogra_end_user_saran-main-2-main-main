...
class TempFreshcutsProducts extends StatefulWidget {
  const TempFreshcutsProducts({
    super.key,
  ...
  @override
  State<TempFreshcutsProducts> createState() => _TempFreshcutsProductsState();
}

class _TempFreshcutsProductsState extends State<TempFreshcutsProducts> {
  List orderedFoods = [];
  List<int> qty = [];
  ...
  Future<dynamic> fetchDataFromListJson() async {
    ...
    String url =
        'https://${ApiServices.ipAddress}/category_based_fresh/${widget.subCategoryName}';
  ...
  //       .get(Uri.parse('https://${ApiServices.ipAddress}/all_foodproducts/'));
