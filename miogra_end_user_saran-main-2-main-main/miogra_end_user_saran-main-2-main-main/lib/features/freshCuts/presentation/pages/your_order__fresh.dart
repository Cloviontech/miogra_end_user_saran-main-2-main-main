...
class GoToOrderFreshCuts extends StatefulWidget {
  ...
  @override
  State<GoToOrderFreshCuts> createState() => _GoToOrderFreshCutsState();
}

class _GoToOrderFreshCutsState extends State<GoToOrderFreshCuts> {
  String userId = '';
  String image = '';
  String productName = '';
  String productId = '';
