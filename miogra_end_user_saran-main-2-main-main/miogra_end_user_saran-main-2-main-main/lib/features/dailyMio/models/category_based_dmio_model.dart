...
//
//     final categoryBasedDmio = categoryBasedDmioFromJson(jsonString);

import 'dart:convert';

List<CategoryBasedDmio> categoryBasedDmioFromJson(String str) => List<CategoryBasedDmio>.from(json.decode(str).map((x) => CategoryBasedDmio.fromJson(x)));

String categoryBasedDmioToJson(List<CategoryBasedDmio> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CategoryBasedDmio {
    String productId;
    String dmioId;
    String status;
    String category;
    ...
    factory CategoryBasedDmio.fromJson(Map<String, dynamic> json) => CategoryBasedDmio(
