// category_based_pharm

// To parse this JSON data, do
//
//     final categoryBasedPharm = categoryBasedPharmFromJson(jsonString);

import 'dart:convert';

List<CategoryBasedPharm> categoryBasedPharmFromJson(String str) => List<CategoryBasedPharm>.from(json.decode(str).map((x) => CategoryBasedPharm.fromJson(x)));

String categoryBasedPharmToJson(List<CategoryBasedPharm> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CategoryBasedPharm {
    String productId;
    String pharmId;
    String status;
    String category;
    ...
    factory CategoryBasedPharm.fromJson(Map<String, dynamic> json) => CategoryBasedPharm(
