...
import 'your_order_pharmacy.dart';

class PharmacyProducDetails extends StatefulWidget {
  const PharmacyProducDetails({
    super.key,
  ...
  @override
  State<PharmacyProducDetails> createState() => _PharmacyProducDetailsState();
}

class _PharmacyProducDetailsState extends State<PharmacyProducDetails> {
  String image = '';
  String productName = '';
  ...
  Future<dynamic> fetchFreshCutDataFromListJson() async {
    String url =
        'https://${ApiServices.ipAddress}/single_pharmproduct/${widget.shopeid}/${widget.productId}';
