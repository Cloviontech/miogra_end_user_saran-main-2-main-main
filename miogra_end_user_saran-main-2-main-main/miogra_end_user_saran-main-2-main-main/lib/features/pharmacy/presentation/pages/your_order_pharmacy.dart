...
class GoToOrderPharmacy extends StatefulWidget {
  ...
  @override
  State<GoToOrderPharmacy> createState() => _GoToOrderPharmacyState();
}

class _GoToOrderPharmacyState extends State<GoToOrderPharmacy> {
  String userId = '';
  String image = '';
  String productName = '';
  String productId = '';
...
//Address
  ...
  Future<dynamic> fetchFetchFreshCutDataFromListJson() async {
    String url =
        'https://${ApiServices.ipAddress}/single_pharmproduct/${widget.shopId}/${widget.productId}';
        ...
        if (data is List) {
          ...
          try {
            setState(() {
              ...
              shopeId = data[0]['pharm_id'].toString();
