...
class RazorPayPaymentCart extends StatefulWidget {
  const RazorPayPaymentCart({
    super.key,
  ...
  @override
  State<RazorPayPaymentCart> createState() => _RazorPayPaymentCartState();
}

class _RazorPayPaymentCartState extends State<RazorPayPaymentCart> {
